...
import { ranksHandler } from './ranksHandler';

async function mainHandler(client: Client, message: Message, guildData: StatClass, botMessage?: Message) {
    const query = {
    ...
    collector.on('collect', async (i: StringSelectMenuInteraction) => {
        ...
        if (option.type === 'ranks') ranksHandler(client, message, guildData, question);
    });
